...
The main objective of this project is to explore the 10 Academy Moodle logs stored in the database together with many other relevant tables, and build a Tableau dashboard that illustrates the progress of students across time. </span></p>
        <p>
